...
learning_keyboard = ReplyKeyboardMarkup(resize_keyboard=True).row(KeyboardButton('Не помню'), KeyboardButton('Помню'))
learning_keyboard.row(KeyboardButton('Хочу проверить себя')).row(return_button)
